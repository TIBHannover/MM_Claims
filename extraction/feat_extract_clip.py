...
print("Extracting features from:", model_nms[clip_nm], split,"-------------------------------")

text_dict = json.load(open('data/%s_text.json'%(split), 'r', encoding='utf-8'))
...
json.dump(feat_dict, open('features/clip_%s_%s.json'%(model_nms[clip_nm], split),'w'))
